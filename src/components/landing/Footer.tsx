      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <svg 
                viewBox="0 0 24 24" 
                className="h-6 w-6 text-brandBlue-600"
                fill="currentColor"
              >
              ...
              <span className="text-lg font-semibold text-gray-800">WhatsApp Lead Pilot</span>
            </div>
            <p className="text-gray-600 mb-4">
              Plataforma de prospecção automatizada via WhatsApp Web. Transforme dados em vendas com eficiência.
            </p>
          ...
          <div>
            <h3 className="text-gray-800 font-semibold mb-4">Produto</h3>
            <ul className="space-y-2">
              <li><a href="#features" className="text-gray-600 hover:text-gray-900">Recursos</a></li>
              <li><a href="#how-it-works" className="text-gray-600 hover:text-gray-900">Como Funciona</a></li>
              <li><a href="#pricing" className="text-gray-600 hover:text-gray-900">Preços</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Termos de Serviço</a></li>
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Política de Uso</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Vendas</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">Parcerias</a></li>
        ...
        <div className="pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} WhatsApp Lead Pilot. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
